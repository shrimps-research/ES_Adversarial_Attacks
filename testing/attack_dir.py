...
for img_name in os.listdir(src_dir):
    ...
    attack = subprocess.run(["python", "attack_main.py", "-model", "xception_classifier", "-device", "cuda", "-eval", "crossentropy", "-in", dst_dir+"/", "-tl", "48", "-min", "-b", "1000", "-ps", "12", "-os", "50", "-d", "0.9", "-e", "0.05", "-r", "global_discrete", "-m", "individual", "-s", "comma_selection", "-fp", "5", "-v", "2"], capture_output=True, text=True)
